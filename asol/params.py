...
def args_read() -> Dict[str, any]:
    ...
    parser.add_argument("--graph-count-files-week", required=False, help="Graph number of files (posts) in individual weeks. Generates a file inside source dir given by -i",action='store_true')
